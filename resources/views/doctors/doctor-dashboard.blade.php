                ...
                <div class="modal-body">
                    @forelse ($uniquePatients as $patient)
                        <div>
                            ...
                            <p class="m-0">Birthdate: {{ $patient->birthdate ? \Carbon\Carbon::parse($patient->birthdate)->format('F j, Y') : 'N/A' }}</p>
                            <p class="m-0">Age: {{ $patient->birthdate ? \Carbon\Carbon::parse($patient->birthdate)->age : 'N/A' }} years</p>
                        </div>
                        <hr>
                    @empty
