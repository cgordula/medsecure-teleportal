...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="{{ route('patients.patient-dashboard') }}" class="sidebar-link" data-title="Patient Dashboard">
        ...
        <a href="{{ route('patients.create-appointment') }}" class="sidebar-link" data-title="Create Appointment">
